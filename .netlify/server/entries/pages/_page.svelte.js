...
const NoIssues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<p class="text-gray-400 px-3" data-svelte-h="svelte-iaqmii">이 카테고리에서 진행 중인 이슈가 없어요 🙂</p>`;
});
  ...
  return ` ${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})} ${validate_component(Carousel, "Carousel").$$render($$result, {}, {}, {})} <div class="text-center">${validate_component(ShareButton, "ShareButton").$$render($$result, {}, {}, {})}</div> <main class="container mx-auto"><h1 class="text-xl font-bold mx-1 my-5 text-center text-gray-500" data-svelte-h="svelte-5zqx56">T-아고라를 통해 참여 완료된 이슈</h1> <p class="text-center text-6xl text-primary font-bold">${escape(participants.toLocaleString())}</p> <div class="text-center mt-5 text-secondary font-bold">${isLoggedInCheck ? `<p>선생님께서 참여하신 이슈는 ${escape(participatedIssuesCount)}건으로
    ...
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(fire.bgColor, true) + " " + escape(fire.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="${"badge " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-66v49s">❌ 입법 반대</h1> <div class="flex flex-wrap">${issuesDisagree.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesDisagree, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(disagree.bgColor, true) + " " + escape(disagree.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-red-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-1r7m58w">✅ 입법 찬성</h1> <div class="flex flex-wrap">${issuesAgree.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesAgree, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(agree.bgColor, true) + " " + escape(agree.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-green-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-1tuja1e">🙆 국민동의청원</h1> <div class="flex flex-wrap">${issuesPetition.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesPetition, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(petition.bgColor, true) + " " + escape(petition.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-teal-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-1ogoq7q">🎤 설문</h1> <div class="flex flex-wrap">${issuesSurvey.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesSurvey, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(survey.bgColor, true) + " " + escape(survey.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-purple-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-ccjehd">📑 서명</h1> <div class="flex flex-wrap">${issuesSignature.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesSignature, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(signature.bgColor, true) + " " + escape(signature.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-orange-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-rcav9f">📰 언론</h1> <div class="flex flex-wrap">${issuesPress.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesPress, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(press.bgColor, true) + " " + escape(press.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-gray-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <h1 class="text-3xl font-bold mt-20 mx-3" data-svelte-h="svelte-rw0ig6">🎸 기타</h1> <div class="flex flex-wrap">${issuesOther.length === 0 ? `${validate_component(NoIssues, "NoIssues").$$render($$result, {}, {}, {})}` : ``} ${each(issuesOther, (issue) => {
    return `<div class="p-2 w-full lg:w-96"><div class="${"card " + escape(other.bgColor, true) + " " + escape(other.textColor, true) + " shadow-xl"}"><div class="card-body"><div class="badge bg-indigo-300">${escape(issue.category)}</div> <h2 class="card-title">${escape(issue.title)}</h2> <p>${escape(issue.summary)}</p> <div class="flex justify-between my-5"><button class="${"btn btn-circle " + escape(
      ...
      true
								...
								` : `
									미참여
								`}</button> <a${add_attribute("href", issue.link, 0)} target="_blank" class="btn bg-white">참여하기</a></div> <div><span class="text-xs">마감일 ${escape(formatDate(issue.dueDate))}</span> ${ADMIN_ID_LIST.includes(userId) ? `<a href="${"/admin0904/issues/" + escape(issue._id, true)}" target="_blank" class="text-xs link link-primary">이슈 관리</a>` : ``}</div> </div></div> </div>`;
  })}</div> <div class="text-center mt-20" data-svelte-h="svelte-vb1u60"><a href="/issues/closed" class="link link-error">마감된 이슈 보기</a></div> <p class="text-center text-gray-400 mt-10 text-sm" data-svelte-h="svelte-1896r3c">Managed by <span class="font-bold">검은점 초등교사</span></p></main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
