...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})} <div class="container mx-auto mx-auto p-3" data-svelte-h="svelte-r5ros5"><h1 class="text-center text-3xl font-bold mb-20 text-success">초대 링크를 통해서만 가입할 수 있어요 😅</h1> <h2 class="text-2xl font-bold text-error">🔥 꼭 읽어주세요</h2> <br> <h3 class="text-xl font-bold">T-아고라는 현직 교사 커뮤니티입니다.</h3> <p class="my-3">1️⃣ 현직 교사만 가입할 수 있습니다.
		<br>
		* 유치원, 초등, 중등, 특수 등 <span class="font-bold">교과 교사</span>에 한하여 가입을 받고
		...
		소명 자료를 제출하여야 해제됩니다.</p> <div class="my-20"></div></div> `;
});
export {
  Page as default
};
